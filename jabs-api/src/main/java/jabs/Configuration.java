...
public interface Configuration {
   ...
   *
   * @return the {@link jabs.Router} of the context
   */
  Router getRouter();
   ...
   *
   * @return the {@link jabs.Opener} of the context
   */
  Opener getOpener();
   ...
   *
   * @return the {@link jabs.Inbox} of the context
   */
  Inbox getInbox();
  ...
  /**
   * Creates an instance of {@link jabs.ConfigurationBuilder}
   * to build an instance of {@link jabs.Configuration}.
   *
   * @return an instance of builder for a
   *         {@link jabs.Configuration}
   */
